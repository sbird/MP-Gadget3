...
create_gadget_parameter_set()
{
    ...
    param_declare_double(ps, "PairwiseActiveFraction", OPTIONAL, 1e-4, "Pairwise gravity instead of tree gravity is used if N(active particles) / N(particles) is less than this.");
